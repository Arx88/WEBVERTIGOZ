...
export default function Step7Handbook() {
  ...
  return (
    <div style={{ maxWidth: "560px" }}>
      ...
      <button className={`btn ${downloaded ? "ghost" : "primary"}`}
        onClick={() => { window.open("https://tomlvgzwleolsxksiygs.supabase.co/storage/v1/object/public/handbook/vertigo-handbook.pdf", "_blank"); updateData({ handbookDownloadedAt: new Date() }); }}
        disabled={downloaded}>
