...
// ============================================================
// Wizard de inscripción VÉRTIGO — Estado global
// ============================================================
...
export function WizardProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <WizardContext.Provider
      value={{ step, totalSteps: TOTAL, data, setStep, nextStep, prevStep, updateData, updatePlayer, resetWizard }}
    >
      {children}
    </WizardContext.Provider>
  );
...
export const WIZARD_STEPS = [
  { num: 1, short: "Cuenta" },
  { num: 2, short: "Equipo" },
  { num: 3, short: "Jugadores" },
  { num: 4, short: "Capitán" },
  { num: 5, short: "9 civs" },
  { num: 6, short: "3 civs extra" },
  { num: 7, short: "Handbook" },
  { num: 8, short: "Términos" },
  { num: 9, short: "Confirmar" },
] as const;
